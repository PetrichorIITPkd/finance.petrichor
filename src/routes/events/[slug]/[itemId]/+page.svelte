...
<main>
    ...
    <div class="update_Area">
        ...
        <form method="post" action="?/update" enctype="multipart/form-data" use:enhance={handleUpdate}>
            ...
            <span class="isTeam">
                <p>isTeam: <br/>if set to <strong>false</strong> then above fee is considered as <strong>per participant fee</strong> i.e. amount taken by user = event.fee * no_of_participants.
                    <br/> if set to <strong>true</strong> then above fee is considered as <strong>'per team fee'</strong> i.e. amount taken by user = event.fee(the number of participants is not considered for fee calculation)</p>
